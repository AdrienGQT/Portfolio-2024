    ...
    <div class="header__left">
        <a href="/index.php">
            <h3 class="header__title">
                <span class="anim-appear-header">Adrien</span>
                <span class="anim-appear-header">Gasquet</span>
            </h3>
        </a>

    </div>
    <div class="header__right">
        <a class="button button--c-1 anim-appear-header" href="/client-data/pdf/CV - Adrien Gasquet.pdf" download="CV - Adrien Gasquet" href="src/pages/design/liftoffrockets.php">
            <div class="button__icon button__icon--download"></div>
            <p class="button__text">CV</p>
        </a>
        <div class="language-selector anim-appear-header">
